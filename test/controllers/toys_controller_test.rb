...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference("Toy.count") do
      post toys_url, params: { toy: { buyable_id: @toy.buyable_id, buyable_type: @toy.buyable_type } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { buyable_id: @toy.buyable_id, buyable_type: @toy.buyable_type } }
